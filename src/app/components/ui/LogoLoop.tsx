        ...
        const updateDimensions = useCallback(() => {
            ...
            if (isVertical) {
                ...
                if (sequenceHeight > 0) {
                    ...
                    const viewportHeight = containerRef.current?.clientHeight ?? parentHeight ?? sequenceHeight;
                    const copiesNeeded = Math.ceil(viewportHeight / sequenceHeight) + ANIMATION_CONFIG.COPY_HEADROOM;
